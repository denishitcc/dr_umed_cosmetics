...
*/
describe('Process Tests', () => {
    it('Should submit data within a nested form.', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            _id: {},
        ...
        const context = {
            ...
            processors: index_1.ProcessTargets.submission,
            scope: { errors },
            config: {
                server: true
            }
        ...
        context.processors = index_1.ProcessTargets.evaluator;
        (0, index_1.processSync)(context);
        assert.equal(context.scope.errors.length, 0);
    }));
    it('Should process nested form data correctly', () => __awaiter(void 0, void 0, void 0, function* () {
        const submission = {
            data: {
                submit: true,
                child: {
        ...
        const context = {
            ...
            data: submission.data,
            components: form.components,
            processors: index_1.ProcessTargets.evaluator,
            scope: {},
            config: {
                server: true
            }
    ...
    it('Should process nested data correctly.', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            _id: {},
            title: "parent",
            name: "parent",
    ...
    it('Should allow the submission to go through if the subform is conditionally hidden', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            _id: {},
            title: "parent",
            name: "parent",
    ...
    it('Should process data within a fieldset properly.', () => __awaiter(void 0, void 0, void 0, function* () {
        const submission = {
            data: {
                firstName: 'Joe',
                lastName: 'Smith'
    ...
    it('Requires a conditionally visible field', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Doesn\'t require a conditionally hidden field', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Allows a conditionally required field', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Ignores conditionally hidden fields', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Requires a conditionally visible field in a panel', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Doesn\'t require a conditionally hidden field in a panel', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Allows a conditionally required field in a panel', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Ignores conditionally hidden fields in a panel', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            components: [
                {
                    "input": true,
    ...
    it('Should not include submission data for conditionally hidden fields', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            display: 'form',
            components: [
                {
    ...
    it('Should not include submission data for logically hidden fields', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            display: 'form',
            components: [
                {
    ...
    it('Should allow conditionally hidden text fields within DataGrid and EditGrids', () => __awaiter(void 0, void 0, void 0, function* () {
        const form = {
            display: 'form',
            components: [
                {
    ...
    describe('Required component validation in nested form in DataGrid/EditGrid', () => {
        ...
        describe('For DataGrid:', () => {
            ...
            it('Should validate required component when it is filled out', () => __awaiter(void 0, void 0, void 0, function* () {
                const submission = {
                    data: {
                        dataGrid: [
                            {
            ...
            it('Should not validate required component when it is not filled out', () => __awaiter(void 0, void 0, void 0, function* () {
                const submission = {
                    data: {
                        dataGrid: [
                            {
