...
export type Component = TextFieldComponent | NestedComponent | ContainerComponent | AddressComponent | ButtonComponent | CheckboxComponent | ColumnsComponent | ContentComponent | NumberComponent | NestedArrayComponent | DataGridComponent | DataMapComponent | DataSourceComponent | DateTimeComponent | DayComponent | EditGridComponent | EmailComponent | FieldSetComponent | FileComponent | FormComponent | HiddenComponent | HtmlComponent | PanelComponent | PasswordComponent | PhoneNumberComponent | ListComponent | RadioComponent | RecaptchaComponent | SelectComponent | ResourceComponent | SelectBoxesComponent | SignatureComponent | SurveyComponent | RowComponent | TabsComponent | TagsComponent | TextAreaComponent | TimeComponent | UrlComponent | WellComponent;
