...
<main>
    <div class="card">
        ...
        <form id="create_user" name="create_user" class="form">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-lg-4">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select class="form-select form-control" name="role_type">
                ...
                <div class="col-lg-4">
                    <div class="form-group">
                        ...
                        <select class="form-select form-control" name="access_level">
            ...
            <div class="row">
                ...
                <div class="col-lg-2 text-center">
                    <figure class="profile-img"><img src="../img/demo-photo.jpeg" alt=""></figure>
