...
<div class="card">
    ...
    <ul class="nav brand-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#tab_5" aria-selected="false" tabindex="-1" role="tab"><i class="ico-appt-reminder"></i> Forms<span class="badge badge-circle ms-2"> {{ $allformscount }} </span></a>
        </li>
        <li class="nav-item">
