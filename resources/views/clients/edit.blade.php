...
<div class="card">
    ...
    <ul class="nav brand-tabs" role="tablist">
        ...
        <li class="nav-item">
            <a class="nav-link" data-bs-toggle="tab" href="#tab_5" aria-selected="false" tabindex="-1" role="tab"><i class="ico-appt-reminder"></i> Forms<span class="badge badge-circle ms-2"> {{ isset($allformscount) ? $allformscount : 0  }} </span></a>
        </li>
        <li class="nav-item">
                                            ...
                                            <div class="his-detaiils">
                                                ...
                                                @if (isset($appointment->note->notescount))
                                                    ...
                                                    <div class="add-note-btn-box">
                                                        ...
                                                        <a href="javascript:void(0);" class="btn btn-primary font-13 me-2" id="add_notes" data-appointment_id="{{ $appointment->id }}"> Add Booking Notes </a>
                                                        @endif
                                                    </div>
                                                @else
                                                <div class="add-note-btn-box">
                            ...
                            <li class="scaffold-layout-list-item">
                                ...
                                <div class="appt-details">
                                    <div class="his-detaiils">
                                        ...
                                        <span class="font-13">(Uninvoiced) : $0.00</span></p>
                                        <div class="add-note-btn-box">
                                            <a href="#" class="btn btn-primary font-13 me-2">Add Booking Notes</a>
                    ...
                    @foreach ($allforms as $day => $allforms)
                        ...
                        <tbody>
                            @foreach ($allforms as $userforms)
                                <tr class="pnl-head" data-client_form_data="{{$userforms->forms->form_json}}" data-client_form_json="{{$userforms->form_user_data}}" data-form_title="{{ $userforms->forms->title }}">
                                    <td>
                                        <a href="#" style="color: #0747A6;">{{ $userforms->forms->title }}</a>
                                    </td>
                                    <td>
        ...
        $('.accordion-panel-header').each(function(){
            ...
            $(this).click(function(e) {
                ...
                if ($(this).hasClass('toggled')) {
                    ...
                    var client_form_data = $(this).data('client_form_data');
                    var client_form_json = $(this).data('client_form_json');
                    ...
                    $('#formTitle').html(form_title);

                    // var json        = $.parseJSON(client_form_json),
                    // formvalue       = $.parseJSON(client_form_data);
                    console.log(client_form_json);
                    console.log(client_form_data);
                Formio.createForm(document.getElementById('fb-editor'), client_form_json, {
                    readOnly: true
                }).then((form) => {
                    // Set the submission data
                    form.submission = client_form_data;
                }).catch((err) => {
