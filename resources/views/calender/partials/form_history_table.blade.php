@foreach ($allforms as $day => $allforms)
    ...
    <tbody>
        @foreach ($allforms as $userforms)
            <tr>
                <td style="cursor: pointer" class="form_filled" data-client_forms_id="{{ $userforms->id }}"><a href="javascript:void(0);" style="color: #0747A6;">{{ $userforms->forms->title }}</a></td>
                <td>
