...
<div class="card">
    <div class="card-head">
        <div class="toolbar mb-5">
            <div class="tool-left"><h4 class="small-title mb-0">Edit Services</h4></div>
    ...
    <div class="card-body">
            ...
            <div class="col-lg-7">
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="service_name" id="service_name" maxlength="50" value="{{$services->service_name}}">
                            </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select class="form-select form-control" name="gender_specific" id="gender_specific">
                                <option selected="" value=""> -- select an option -- </option>
                                <option value="Anyone" {{ ($services->gender_specific == "Anyone")? "selected" : "" }}>Anyone</option>
                                <option value="Only females" {{ ($services->gender_specific == "Only females")? "selected" : "" }}>Only females</option>
                                <option value="Only males" {{ ($services->gender_specific == "Only males")? "selected" : "" }}>Only males</option>
                            </select>
                            </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="code" id="code" value="{{$services->code}}">
                            </div>
                    </div>
                </div>
                ...
                <div class="bor-box pd-20">
                    <div class="form-group">
                        ...
                        <label class="cst-check d-flex align-items-center"><input type="checkbox" name="appear_on_calendar" value="1" {{$services->appear_on_calendar=='1'?'checked':''}} class="appear_on_calendar"><span class="checkmark me-2"></span>Appear on Calendar</label>
                    </div>
                    ...
                    <div class="row main_appear_on_calendar">
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="0" id="duration" name="duration" maxlength="3" value="{{$services->duration}}">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="0" id="processing_time" name="processing_time" maxlength="3" value="{{$services->processing_time}}">
                                    <span class="input-group-text font-12">Mins</span>
                                    </div>
                                </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="0" id="fast_duration" name="fast_duration" maxlength="3" value="{{$services->fast_duration}}">
                                    <span class="input-group-text font-12">Mins</span>
                                    </div>
                                </div>
                        </div>
                        <div class="col-lg-3">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="text" class="form-control" placeholder="0" id="slow_duration" name="slow_duration" maxlength="3" value="{{$services->slow_duration}}">
                                    <span class="input-group-text font-12">Mins</span>
                                    </div>
                                </div>
                        </div>
                    ...
                    <div class="row main_appear_on_calendar">
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <label class="cst-check d-flex align-items-center"><input type="checkbox" name="dont_include_reports" value="1" {{ ( $services->dont_include_reports == '1') ? 'checked' : '' }}><span class="checkmark me-2"></span>Don't include in reports</label>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <input type="hidden" name="technical_service" value="0">
                                <label class="cst-check d-flex align-items-center"><input type="checkbox" name="technical_service" value="1" {{ ( $services->technical_service == '1') ? 'checked' : '' }}><span class="checkmark me-2"></span>Technical service</label>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="mb-3">
                                <input type="hidden" name="available_on_online_booking" value="0">
                                <label class="cst-check d-flex align-items-center"><input type="checkbox" name="available_on_online_booking" value="1" {{ ( $services->available_on_online_booking == '1') ? 'checked' : '' }} checked><span class="checkmark me-2"></span>Available in Online Booking</label>
                            </div>
                        </div>
                    </div>
                    <div class="row main_appear_on_calendar">
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <label class="cst-check d-flex align-items-center"><input type="checkbox" name="require_a_room" value="1" {{ ( $services->require_a_room == '1') ? 'checked' : '' }}><span class="checkmark me-2"></span>Requires a room/equipment</label>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group">
                                <input type="hidden" name="unpaid_time" value="0">
                                <label class="cst-check d-flex align-items-center"><input type="checkbox" name="unpaid_time" value="1" {{ ( $services->unpaid_time == '1') ? 'checked' : '' }}><span class="checkmark me-2"></span>Unpaid time</label>
                            </div>
                        </div>
                    ...
                    <div class="row main_appear_on_calendar">
                        <div class="col-lg-12">
                            <div class="form-group">
                                ...
                                <label class="cst-check d-flex align-items-center"><input type="checkbox" name="require_a_follow_on_service" value="1" {{ ( $services->require_a_follow_on_service == '1') ? 'checked' : '' }}><span class="checkmark me-2"></span>Requires a follow-on service</label>
                            </div>
                        </div>
                        <div class="col-lg-7">
                            <div class="form-group mb-0">
                                ...
                                <select class="form-select form-control" id="choices-multiple-remove-button" name="follow_on_services[]" multiple>
        ...
        <div class="col-lg-2">
            <div class="form-group">
                ...
                <div class="input-group">
                    <input type="text" class="form-control" placeholder="0" name="standard_price" maxlength="5" value="{{$services->standard_price}}">
