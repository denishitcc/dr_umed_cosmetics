<div class="modal fade" id="edit_timetable" tabindex="-1">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="invo-notice mb-4">
                    <div class="inv-left">Bianca (Therapist) Laycock</div>
                    <div class="inv-right d-grey">Tue 17 Oct 2023</div>
                </div>
                <ul class="nav nav-pills nav-fill nav-group mb-3">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#dtab_1">Timetable <i
                                class="ico-tick ms-1"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#dtab_3">Leave <i class="ico-tick ms-1"></i></a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade show active" id="dtab_1" role="tabpanel">
                        <!-- toggle -->
                        <div class="cst-toggle">
                            <div class="row">
                                <div class="col-md-6">
                                    <a href="#" class="btn btn-dashed w-100 btn-blue icon-btn-center mb-2"><i
                                            class="ico-add me-2 fs-5"></i> Timetable</a>
                                </div>
                                <div class="col-md-6">
                                    <a href="#" class="btn btn-dashed w-100 btn-blue icon-btn-center mb-2"><i
                                            class="ico-copy me-2 fs-5"></i> Copy from other staff</a>
                                </div>
                            </div>
                    ...
                    <div class="tab-pane fade" id="dtab_3" role="tabpanel">3</div>
                </div>
